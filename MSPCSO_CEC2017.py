...
def RunMSPCSO():
    ...
    np.savetxt("./MSPCSO_Data/CEC2017/F" + str(FuncNum) + "_" + str(DimSize) + "D.csv", All_Trial_Best, delimiter=",")
...
if __name__ == "__main__":
    if os.path.exists('./MSPCSO_Data/CEC2017') == False:
        os.makedirs('./MSPCSO_Data/CEC2017')
    Dims = [50, 100]
    for Dim in Dims:
        main(Dim)
